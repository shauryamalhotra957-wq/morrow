# morrow-rehearsal-lab: Architecture & System Topology

**Domain**: Local-First Crisis Rehearsal Lab with 72-Hour Cascade Model  
**Description**: Offline-capable PWA crisis rehearsal simulator modeling 72-hour cascade impacts and bounded multi-objective resource portfolios.
...
sequenceDiagram
    ...
    participant Engine as morrow-rehearsal-lab Core
